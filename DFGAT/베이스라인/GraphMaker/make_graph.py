...
class GraphMaker():
    ...
    def load_file(self):
        ...
        with open(f"/home/jinsoo/2025_SCI/DFGAT/베이스라인/Data/{self.dataset}_trn.pkl", 'rb') as fp:
            train_data = pickle.load(fp)
        with open(f"/home/jinsoo/2025_SCI/DFGAT/베이스라인/Data/{self.dataset}_val.pkl", 'rb') as fp:
            val_data = pickle.load(fp)
        with open(f"/home/jinsoo/2025_SCI/DFGAT/베이스라인/Data/{self.dataset}_tst.pkl", 'rb') as fp:
