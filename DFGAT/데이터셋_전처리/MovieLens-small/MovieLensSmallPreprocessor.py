...
class MovieLensSmallPreprocessor():
    def __init__(self):
        self.movieIdxRemapper = defaultdict(int)
        self.userIdxRemapper = defaultdict(int)

        self.movies_path = "./movieLens-small/movies.csv"
        self.ratings_path = "./movieLens-small/ratings.csv"
    ...
    def split_save_pkl(self):
        ...
        with open("movielens_small_trn.pkl", 'wb') as fp:
            pickle.dump(train_edges, fp)
        with open("movielens_small_val.pkl", 'wb') as fp:
            pickle.dump(val_edges, fp)
        with open("movielens_small_tst.pkl", 'wb') as fp:
